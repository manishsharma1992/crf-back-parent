...
public class LeverageAnalysisHistoryJpaEntity {
    ...
    private LeverageAnalysisStatus fromStatus;

    @Enumerated(EnumType.STRING)
    @Column(name = "to_status", nullable = false)
    private LeverageAnalysisStatus toStatus;
    ...
    public LeverageAnalysisStatus getFromStatus() {
        return fromStatus;
    }

    public LeverageAnalysisStatus getToStatus() {
        return toStatus;
    }

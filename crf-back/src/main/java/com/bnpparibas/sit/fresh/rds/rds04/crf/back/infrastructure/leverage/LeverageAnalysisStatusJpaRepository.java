 ...
 */
public interface LeverageAnalysisStatusJpaRepository
    ...
    int compareAndSetStatus(@Param("analysisUid") String analysisUid,
                            @Param("expectedStatus") LeverageAnalysisStatus expectedStatus,
                            @Param("newStatus") LeverageAnalysisStatus newStatus,

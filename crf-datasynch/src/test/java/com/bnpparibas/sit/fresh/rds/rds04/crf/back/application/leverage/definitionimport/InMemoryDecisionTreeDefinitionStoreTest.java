...
class InMemoryDecisionTreeDefinitionStoreTest extends DecisionTreeDefinitionStoreContractTest {

    private InMemoryDecisionTreeDefinitionStore store;

    @BeforeEach
    void reset() {
        store = new InMemoryDecisionTreeDefinitionStore();
    }

    @Override
    protected DecisionTreeDefinitionStore store() {
        return store;
    }
}

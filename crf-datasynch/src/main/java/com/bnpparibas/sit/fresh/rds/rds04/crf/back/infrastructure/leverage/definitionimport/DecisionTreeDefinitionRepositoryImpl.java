...
public final class DecisionTreeDefinitionRepositoryImpl implements DecisionTreeDefinitionRepository {

    private final LeverageDecisionTreeDefinitionDao dao;

    public DecisionTreeDefinitionRepositoryImpl(LeverageDecisionTreeDefinitionDao dao) {
        this.dao = dao;
    }

 ...
 */
public interface DecisionTreeDefinitionRepository {
     ...
     * Idempotent: closing an already-closed form does nothing. Audit columns are set by
     * {@code BaseEntity}, so no author is passed.
     */
    void supersede(LeverageFormType form, Instant at);

    /** Inserts a new version, open-ended ({@code valid_to} null). */
    void save(DecisionTreeDefinition definition, Instant validFrom);
